...
export type HomeSwordsTableContents = {
  ...
  hp: number; // HP
  hp_max: number; // 最大HP
  atk: number; // 打撃 *男士自身の値，刀装・馬の補正無し
  def: number; // 統率 *男士自身の値，刀装・馬の補正無し
  mobile: number; // 機動 *男士自身の値，刀装・馬の補正無し
  back: number; // 衝力 *男士自身の値，刀装・馬の補正無し
  scout: number; // 偵察 *男士自身の値，刀装・馬の補正無し
  hide: number; // 隠蔽 *男士自身の値，刀装・馬の補正無し
  loyalties: number; // 必殺
...
export const homeSwordsTableContentsInitialState: HomeSwordsTableContents = {
  ...
  hp: 1,
  hp_max: 1, // 最大HP
  atk: 1, // 打撃 *男士自身の値，刀装・馬の補正無し
  def: 1, // 統率 *男士自身の値，刀装・馬の補正無し
  mobile: 1, // 機動 *男士自身の値，刀装・馬の補正無し
  back: 1, // 衝力 *男士自身の値，刀装・馬の補正無し
  scout: 1, // 偵察 *男士自身の値，刀装・馬の補正無し
  hide: 1, // 隠蔽 *男士自身の値，刀装・馬の補正無し
  loyalties: 1, // 必殺
